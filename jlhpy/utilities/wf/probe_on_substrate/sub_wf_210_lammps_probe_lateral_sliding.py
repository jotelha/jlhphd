# -*- coding: utf-8 -*-
"""Probe on substrate lateral sliding."""
...
class LAMMPSProbeLateralSlidingMain(WorkflowGenerator):
    ...
    - metadata->step_specific->probe_lateral_sliding->rigid_indenter_core_radius
    - metadata->step_specific->probe_lateral_sliding->constant_indenter_velocity
    - metadata->step_specific->probe_lateral_sliding->direction_of_linear_movement (0, 1, or 2 for x,y, or z)
    - metadata->step_specific->probe_lateral_sliding->temperature

    - metadata->step_specific->probe_lateral_sliding->steps
    - metadata->step_specific->probe_lateral_sliding->netcdf_frequency
    - metadata->step_specific->probe_lateral_sliding->thermo_frequency
    - metadata->step_specific->probe_lateral_sliding->thermo_average_frequency

    - metadata->step_specific->probe_lateral_sliding->ewald_accuracy
    - metadata->step_specific->probe_lateral_sliding->coulomb_cutoff
    - metadata->step_specific->probe_lateral_sliding->neigh_delay
    - metadata->step_specific->probe_lateral_sliding->neigh_every
    - metadata->step_specific->probe_lateral_sliding->neigh_check
    - metadata->step_specific->probe_lateral_sliding->skin_distance
    ...
    def main(self, fws_root=[]):
        ...
        dynamic_template_context = {
            'freeze_substrate_layer':       'metadata->step_specific->probe_lateral_sliding->freeze_substrate_layer',
            'rigid_indenter_core_radius':   'metadata->step_specific->probe_lateral_sliding->rigid_indenter_core_radius',
            'constant_indenter_velocity':   'metadata->step_specific->probe_lateral_sliding->constant_indenter_velocity',
            'direction_of_linear_movement': 'metadata->step_specific->probe_lateral_sliding->direction_of_linear_movement',
            'temperatureT':                 'metadata->step_specific->probe_lateral_sliding->temperature',

            'production_steps': 'metadata->step_specific->probe_lateral_sliding->steps',
            'netcdf_frequency': 'metadata->step_specific->probe_lateral_sliding->netcdf_frequency',
            'thermo_frequency': 'metadata->step_specific->probe_lateral_sliding->thermo_frequency',
            'thermo_average_frequency': 'metadata->step_specific->probe_lateral_sliding->thermo_average_frequency',
            'restart_frequency': 'metadata->step_specific->probe_lateral_sliding->restart_frequency',

            'ewald_accuracy':   'metadata->step_specific->probe_lateral_sliding->ewald_accuracy',
            'coulomb_cutoff':   'metadata->step_specific->probe_lateral_sliding->coulomb_cutoff',
            'neigh_delay':      'metadata->step_specific->probe_lateral_sliding->neigh_delay',
            'neigh_every':      'metadata->step_specific->probe_lateral_sliding->neigh_every',
            'neigh_check':      'metadata->step_specific->probe_lateral_sliding->neigh_check',
            'skin_distance':    'metadata->step_specific->probe_lateral_sliding->skin_distance',
...
class LAMMPSRecoverableProbeLateralSlidingMain(WorkflowGenerator):
    """
...
class LAMMPSProbeLateralSliding(
        DefaultPullMixin, DefaultPushMixin,
        LAMMPSRecoverableProbeLateralSlidingMain,
        ):
    pass