...
class LAMMPSEquilibrationNPTMain(SubWorkflowGenerator):
    """
    NPT equilibration with LAMMPS.
    ...
    - metadata->step_specific->equilibration->npt->steps
    - metadata->step_specific->equilibration->npt->netcdf_frequency
    ...
    - metadata->step_specific->equilibration->npt->skin_distance
...
class LAMMPSEquilibrationNPTSubWorkflowGenerator(
        DefaultPullMixin, DefaultPushMixin,
        ProcessAnalyzeAndVisualizeSubWorkflowGenerator,
        ):
    def __init__(self, *args, **kwargs):
        sub_wf_name = 'LAMMPSEquilibrationNPT'
