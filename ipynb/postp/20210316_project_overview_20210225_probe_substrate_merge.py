...
# %%
readme = await dl.readme(res[100]['uri'])
...
# %%
res_pivot.to_excel('20210225_probe_substrate_merge_hemicylinders.xlsx')
...
# %%
res_pivot.to_excel('20210225_probe_substrate_merge_monolayers.xlsx')
